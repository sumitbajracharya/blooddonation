...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                ddl_bloodgroup.SelectedValue = Request.QueryString["BloodGroup"];
                ddl_location.SelectedValue = Request.QueryString["District"];
            }
            //bindregister();
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMessage.Text = "Select BloodGroup and District";
        }
        else
        {
